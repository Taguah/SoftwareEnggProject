...
public class AnalyzerGUI extends javax.swing.JFrame {
    ...
    public void TranscriptListFrame() {
        ...
        if (transcriptT.getText().compareTo("") == 0) {
            ...
            //System.out.println("tListFrame executed");
            tl.setModel(model);
    ...
    private void initComponents() {
        ...
        javax.swing.GroupLayout TranscriptListFrameLayout = new javax.swing.GroupLayout(
                TranscriptListFrame.getContentPane());
        TranscriptListFrame.getContentPane().setLayout(TranscriptListFrameLayout);
        TranscriptListFrameLayout.setHorizontalGroup(TranscriptListFrameLayout
                .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(TranscriptListFrameLayout.createSequentialGroup().addGroup(TranscriptListFrameLayout
                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(TranscriptListFrameLayout.createSequentialGroup().addGap(150, 150, 150).addComponent(
                                jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 193,
                                javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(TranscriptListFrameLayout.createSequentialGroup().addGap(183, 183, 183)
        ...
        TranscriptListFrameLayout.setVerticalGroup(
                TranscriptListFrameLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(TranscriptListFrameLayout.createSequentialGroup().addContainerGap()
        ...
        RankFrameLayout
                .setHorizontalGroup(RankFrameLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(RankFrameLayout.createSequentialGroup().addGap(5, 5, 5)
                                .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap(151, Short.MAX_VALUE)));
        RankFrameLayout.setVerticalGroup(RankFrameLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(RankFrameLayout.createSequentialGroup().addGap(10, 10, 10)
                        .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        MessageFrameLayout
                .setHorizontalGroup(
                        MessageFrameLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(MessageFrameLayout.createSequentialGroup().addGap(5, 5, 5)
                                        .addComponent(message, javax.swing.GroupLayout.PREFERRED_SIZE, 300,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addContainerGap(163, Short.MAX_VALUE)));
        MessageFrameLayout
                .setVerticalGroup(MessageFrameLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(MessageFrameLayout.createSequentialGroup().addGap(5, 5, 5)
        ...
        areasB.setText("Attach Area and Equivalency Schemas");
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup().addContainerGap().addComponent(gradeLevelsB)
                                .addGap(33, 33, 33).addComponent(gradeLevelsT, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        259, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(layout.createSequentialGroup().addGap(216, 216, 216)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(transcriptB).addComponent(areasB).addComponent(getMasterB))
                                .addGap(39, 39, 39)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup().addComponent(getOutputsT)
                                                .addGap(57, 57, 57).addComponent(rankB))
                                        .addComponent(transcriptT, javax.swing.GroupLayout.PREFERRED_SIZE, 262,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(inputT, javax.swing.GroupLayout.PREFERRED_SIZE, 262,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
        layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
                .createSequentialGroup().addGap(69, 69, 69)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(areasB)
                        .addComponent(inputT, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(46, 46, 46)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(transcriptB).addComponent(transcriptT, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(88, 88, 88)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(getOutputsT).addComponent(getMasterB).addComponent(rankB))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 88, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(gradeLevelsB).addComponent(gradeLevelsT, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(20, 20, 20)));
    ...
    private void transcriptBActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_transcriptBActionPerformed
        ...
        try {
        	...
        	String error = "Please specify a transcript list text file";
            MessageFrame(error);
        }
    ...
    private void areasBActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_areasBActionPerformed
        ...
        try {
        	...
        	String error = "Please specify an input file of equivalencies/areas";
            MessageFrame(error);
        }
    ...
    private void gradeLevelsBActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_gradeLevelsBActionPerformed
        ...
        try {
        	...
        	String error = "Default level schema chosen";
            MessageFrame(error);
        }
    ...
    private void getMasterBActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_getMasterBActionPerformed
        ...
        while (iter.hasNext()) {
			...
			//System.out.println("Master list parsed");
     ...
     */
     try {
    	 ...
    	 java.util.logging.Logger.getLogger(AnalyzerGUI.class.getName()).log(java.util.logging.Level.SEVERE,
    			 null, ex);
